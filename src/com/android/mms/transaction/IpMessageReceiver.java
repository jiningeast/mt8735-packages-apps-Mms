    ...
    private class ReceiveNotificationTask extends AsyncTask<Intent, Void, Void> {
        ...
        protected Void doInBackground(Intent... intents) {
            ...
            if (NewMessageAction.ACTION_NEW_MESSAGE.equals(action)) {
                ...
                handleUpgrade();
            } else if (IpMessageConsts.ACTION_NOTIFICATION_UPDATE.equals(action)) {
                handleNotificationUpdate(intent);
            } else {
        ...
        private void handleNewMessage(Intent intent) {
            ...
            //        .blockingUpdateNewMessageIndicator(mContext, threadId, false, null);
...
//            }
        ...
        private void handleNotificationUpdate(Intent intent) {
            MmsLog.d(TAG, "handleNotificationUpdate"); 
            MessagingNotification
                    .blockingUpdateNewMessageIndicator(mContext,
