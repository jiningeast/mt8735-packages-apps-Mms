    ...
    @Override
        ...
        @Override
            protected void onStart() {
                ...
                IMmsDialogNotifyExt dialogPlugin = (IMmsDialogNotifyExt) MmsPluginManager.getMmsPluginObject(
                ...
                if (FeatureOption.MTK_GEMINI_SUPPORT) {
                    ...
                    if (mindex == 0) {
                        ...
                        SubscriptionInfo simInfo = subinfoList.get(mindex - 1);
                        if (simInfo != null) {
        ...
        @Override
            protected void onListItemClick(ListView l, View v, int position, long id) {
                ...
                if (mgViewID == OPTION_DRAFTBOX) {  //in draftbox
                    ...
                    /// when edit finish or back, composer will still save, then will reset the state to true.
                    ...
                    if (cursor.getInt(9) == PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND) {
                        if (!mIsSmsEnabled) {
                            Toast.makeText(context, R.string.download_disabled_toast, Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        Cursor c = getContentResolver().query(ContentUris.withAppendedId(MMS_URI, messageid), PDU_PROJECTION, null, null, null);
                        int status = 0;
                ...
                protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
                    ...
                    if (cursor == null || cursor.getCount() == 0) {
                        ...
                        if (cursor != null) {
                            ...
                            ///M: add for fix ALPS01448613, when corsor number is 0, clear selectedState and update ActionMode @{
                ...
                switch(item.getItemId()) {
                    ...
                    case MENU_SIM_SMS:
                        ...
                        if (listSubInfo.size() > 1) { 
                            ...
                            simSmsIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            simSmsIntent.putExtra(PhoneConstants.SUBSCRIPTION_KEY, listSubInfo.get(0).getSubscriptionId());
                            startActivity(simSmsIntent);
                        } else {
        ...
        private class ModeCallback implements ActionMode.Callback {
            ...
            private void confirmMultiDelete() {
                ...
                builder.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                        ...
                        /// M: modify for fix bug ALPS01105172. if user click quickly, maybe run twice onClick and then set twice new progressdialog;
