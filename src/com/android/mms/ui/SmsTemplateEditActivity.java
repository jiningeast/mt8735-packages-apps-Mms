...
public class SmsTemplateEditActivity extends Activity {
    ...
    protected void onResume() {
        ...
        MmsLog.d(TAG, "updateAllQuicktexts allQuickTexts : " + MmsConfig.getQuicktexts());
    ...
    private boolean addST(String str) {
        ...
        values.put(TEXT, str);
        MmsLog.d(TAG, "addST " + str + " values " + values);
    ...
    private int delST(Integer id) {
        MmsLog.d(TAG, "delete quick text" + id);
    ...
    private int updateST(Integer id, String text) {
        ...
        MmsLog.d(TAG, "updateST " + id + " text " + text);
